...
myfile = '/data0/stephey/SORTED/8_9_2017_3_37_20_PM_A05_Q3_10197A.tdms'
file_name = '8_9_2017_3_37_20_PM_A05_Q3_10197A.tdms'
name_to_use = 'Q003'
q003_q_t = 327732493
loc = q003_q_t
...
h5f_training_top = h5py.File('/data1/ryan/dataset/training_q003_top.h5', 'w')
h5f_training_bot = h5py.File('/data1/ryan/dataset/training_q003_bot.h5', 'w')
q003_t_bot = []
q003_t_top = []
...
t_bot = np.array(q003_t_bot)
t_top = np.array(q003_t_top)
np.save('/data1/ryan/dataset/time_q003_top.npy', t_top)
np.save('/data1/ryan/dataset/time_q003_bot.npy', t_bot)
