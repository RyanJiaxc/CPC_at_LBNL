...
myfile = '/data0/stephey/SORTED/8_9_2017_1_56_57_PM_A03_Q1_9677A.tdms'
file_name = '8_9_2017_1_56_57_PM_A03_Q1_9677A.tdms'
name_to_use = 'Q001'
q001_q_t = 185911105
loc = q001_q_t
...
h5f_training_top = h5py.File('/data1/ryan/dataset/training_q001_top.h5', 'w')
h5f_training_bot = h5py.File('/data1/ryan/dataset/training_q001_bot.h5', 'w')
q001_t_bot = []
q001_t_top = []
...
t_bot = np.array(q001_t_bot)
t_top = np.array(q001_t_top)
np.save('/data1/ryan/dataset/time_q001_top.npy', t_top)
np.save('/data1/ryan/dataset/time_q001_bot.npy', t_bot)
