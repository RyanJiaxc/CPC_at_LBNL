...
h5f_training_top = h5py.File('/data1/ryan/dataset/training_q103_top.h5', 'w')
h5f_training_bot = h5py.File('/data1/ryan/dataset/training_q103_bot.h5', 'w')
q103_t_bot = []
q103_t_top = []
...
t_bot = np.array(q103_t_bot)
t_top = np.array(q103_t_top)
np.save('/data1/ryan/dataset/time_q103_top.npy', t_top)
np.save('/data1/ryan/dataset/time_q103_bot.npy', t_bot)
